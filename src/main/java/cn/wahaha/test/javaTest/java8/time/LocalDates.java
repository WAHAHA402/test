...
public class LocalDates {
    ...
    public static void LocalDateUtil() {
        LocalDate id = LocalDate.of(2019, Month.JULY, 4);
        LocalDate christmas = LocalDate.of(2019, Month.DECEMBER, 25);
        System.out.println(id.until(christmas));
        System.out.println(id.until(christmas, ChronoUnit.DAYS));
    }
...
//        System.out.println("今年六月份的第三个周一: " + thirdMondayInJune);
        ...
        System.out.println(atomicInteger.getAndUpdate(v -> Integer.max(9, v)));
